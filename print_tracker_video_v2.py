...
range_red = list(chain(range(1, 11), range(340, 361))) # rote Farbwerte (HSV-Modell)
...
def print_tracker():
    ...
    print_started = False
    printer_homed = False # Um zu erkennen, dass ein Druck gestartet wird, muss sich der Drucker zuvor in der gehomten Position befunden haben
